...
namespace SharpEXR
{
    public sealed class EXRFile
    {
        public EXRVersion Version { get; private set; }

        public List<EXRHeader> Headers { get; private set; }

        public List<OffsetTable> OffsetTables { get; private set; }

        public List<EXRPart> Parts { get; private set; }
